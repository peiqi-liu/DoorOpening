...
from DoorOpening.motion.rmp_wrapper import RMPWrapper
...
class OmniJointController:
    ...
    def _build_ik_controller(self):
        ...
        self.rmp_wrapper = RMPWrapper(self.scene, device="cuda")
    ...
    #     # current_joint_vel = self.scene["robot"].data.joint_vel[:, self.joint_ids[3:]]
    ...
    #     joint_pos_des, joint_vel_des = self.rmp_wrapper.reach_pose(self.xyz, quat)
    #     self.q_slider[0] = joint_pos_des.to(self.q_slider)

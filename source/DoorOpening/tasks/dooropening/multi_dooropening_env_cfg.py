...
class DooropeningEnvCfg(DirectRLEnvCfg):
    ...
    panel_contact_force_threshold = 1.0
    ...
    panel_contact_penalty_w = 3.0
    # Penalty weight (per non-front base face in contact with the door).
    base_door_contact_penalty_w = 1.0
